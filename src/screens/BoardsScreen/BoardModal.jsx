...
export default function BoardModal({ close, isopen }) {
  ...
  const handleCraete = async () => {
    ...
    if (!tName) return dispatch(setToaster("You need to enter board name"));
              ...
              >
                <DialogPanel className="w-full max-w-[440px]  bg-[#383838] p-6 backdrop-blur-2xl">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={close}
                      className="text-4xl hover:bg-gray-600 h-16 w-16 flex items-center justify-center rounded-full"
                    >
                      x
                    </button>
                  </div>
                  <div>
                    ...
                    <div className="mt-6">
                      <button
                        ...
                        disabled={loading}
                        className="w-full bg-[rgb(190,164,255)] px-9 py-4 text-2xl font-bold text-black hover:bg-[rgb(176,146,254)]"
                      >
                        Create
                      </button>
                    </div>
